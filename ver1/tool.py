    ...
    for i in range(0,count):#총 횟수
        ...
        for j in range(0,n):#한 스테이지당 횟수(30초단위)
            ...
            if stage[j] == 'W' :
                    ...
                    copy=open('W/W_data/'+file+'_%d.txt'%count_w,'w+t')
                    copy.writelines('\n'.join(data))
                    copy.close()
                    start=+3000
                    end=+3000
            ...
            if stage[j] == '1' :
                    ...
                    copy=open('1/1_data/'+file+'_%d.txt'%count_o,'w+t')
                    copy.writelines('\n'.join(data))
                    copy.close()
                    start=+3000
                    end=+3000
            ...
            if stage[j] == '2' :
                    ...
                    copy=open('2/2_data/'+file+'_%d.txt'%count_t,'w+t')
                    copy.writelines('\n'.join(data))
                    copy.close()
                    start=+3000
                    end=+3000
            ...
            if stage[j] == '3' :
                    ...
                    copy=open('3/3_data/'+file+'_%d.txt'%count_tr,'w+t')
                    copy.writelines('\n'.join(data))
                    copy.close()
                    start=+3000
                    end=+3000
            ...
            if stage[j] == '4' :
                    ...
                    copy=open('4/4_data/'+file+'_%d.txt'%count_f,'w+t')
                    copy.writelines('\n'.join(data))
                    copy.close()
                    start=+3000
                    end=+3000
